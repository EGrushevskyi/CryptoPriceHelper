...
public class MainActivity extends AppCompatActivity {
    ...
    private CurrenceRVAdapter currenceRVAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RVCurrencies = findViewById(R.id.idRVCurrencies);
        PBLoading = findViewById(R.id.idPBLoading);
        currencyRVModalArrayList = new ArrayList<>();
        currenceRVAdapter = new CurrenceRVAdapter(currencyRVModalArrayList, this);
        RVCurrencies.setLayoutManager(new LinearLayoutManager(this));
        RVCurrencies.setAdapter(currenceRVAdapter);
        getCurrencyData();
    ...
    private void filterCurrencies(String currency) {
        ...
        if(filteredList.isEmpty()){
            ...
            currenceRVAdapter.filterList(filteredList);
        }
    }
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try{
                    ...
                    currenceRVAdapter.notifyDataSetChanged();
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                headers.put("X-CMC_PRO_API_KEY", "9cb71477-2b49-42fd-8680-537b7a7cd59e");
                return headers;
            }
        };
