package com.example.cryptopricehelper;
...
public class CurrenceRVAdapter extends RecyclerView.Adapter<CurrenceRVAdapter.ViewHolder> {
    private ArrayList<CurrencyRVModal> currencyRVModalArrayList;
    private Context context;
    private static DecimalFormat df2 = new DecimalFormat("#.##");

    public CurrenceRVAdapter(ArrayList<CurrencyRVModal> currencyRVModalArrayList, Context context) {
    ...
    @NonNull
    @Override
    public CurrenceRVAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.currency_rv_item, parent, false);
        return new CurrenceRVAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CurrenceRVAdapter.ViewHolder holder, int position) {
